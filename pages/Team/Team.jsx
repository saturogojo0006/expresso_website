  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
        {/* Split text */}
        <div className="text-white text-10xl ml-28 font-antonio font-bold text-center">
          <span className="text-black">Te</span>
          <span className="text-gray-200">am</span>
        </div>

        {/* Bottom bar */}
        <div className="bg-black flex justify-around py-4 mt-10 w-3/4 ml-16 border border-white rounded-full">
